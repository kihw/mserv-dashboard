...
export default class ServicesManager {
  ...
  async loadServicesConfiguration() {
    try {
      ...
      // Utiliser des services de secours si nécessaire
      this.services = this.getFallbackConfig().default_services;
      this.renderServices();
    }
  }
  ...
  /**
   * Retourne une configuration de secours
    ...
    return {
      ...
      default_services: [
        ...
        },
        {
          id: 'portainer',
          name: 'Portainer',
          description: 'Gestion de conteneurs Docker',
        ...
        },
        {
          id: 'gitea',
          name: 'Gitea',
          description: 'Plateforme de dépôts Git',
          url: 'git.mserv.wtf',
          icon: 'gitea',
          category: 'dev'
        },
        ...
        },
        {
          id: 'nextcloud',
          name: 'Nextcloud',
          description: 'Cloud personnel et stockage',
          url: 'cloud.mserv.wtf',
          icon: 'nextcloud',
          category: 'tools'
        }
